...
""".format(self.name))
        ...
        out.write((
            ...
            " */\n"
            "PyObject *%(module)s_get_version(PyObject *self, PyObject *arguments) {\n"
            "    const char *errors = NULL;\n"
            "    return(PyUnicode_DecodeUTF8(\"%(version)s\", (Py_ssize_t) %(version_length)s, errors));\n"
            "}\n"
            "\n"
            "static PyMethodDef %(module)s_methods[] = {\n"
            "    { \"get_version\",\n"
            "        (PyCFunction) %(module)s_get_version,\n"
            "        METH_NOARGS,\n"
            "        \"get_version() -> String\\n\"\n"
            "        \"\\n\"\n"
        ...
        out.write((
            ...
            "\n"
            "    /* create module */\n"
            "    m = Py_InitModule3(\"%(module)s\", %(module)s_methods, \"%(module)s module.\");\n"
        ...
        for constant, type in self.constants:
            if type == 'integer':
                ...
                out.write((
                    ...
                    "#else\n"
                    "    tmp = PyString_FromString((char *)%s);\n"
                    "#endif\n") % (constant, constant))
            else:
                out.write(
                    "    /* I dont know how to convert %s type %s */\n" % (
                        constant, type))
                continue
